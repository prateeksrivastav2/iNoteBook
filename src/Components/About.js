...
const About = () => {
    ...
    let { isChecked, isCollapsed } = context;
    ...
    return (
        <>
        {/* {isCollapsed&&<div style={{marginTop:'100px'}}></div>} */}
            <div className="c" style={{ backgroundColor: `#${bgc}`, marginTop: '5%' }}>
                    ...
                    <div className='query'>
                        ...
                        >
                            ...
                            <div>
                                ...
                                <button className="btn" type="submit" style={{ width: 'fit-content' }}>Ask?</button>
                            </div>
                        </form>
                    </div>
                    <div>
